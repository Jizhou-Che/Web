...
function floor_onchange(){
	...
	function set_room_selection(event){
		if(event.currentTarget.style.backgroundColor == "limegreen"){
			if(document.getElementById("roomNo").value != ""){
				for(var i = 0; i < cells.length; i++){
					if(cells[i].style.backgroundColor == "deepskyblue"){
						cells[i].style.backgroundColor = "limegreen";
					}
				}
			}
			event.currentTarget.style.backgroundColor = "deepskyblue";
